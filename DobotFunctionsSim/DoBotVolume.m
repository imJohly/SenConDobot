function [pointCloud,shp] = DoBotVolume(myRobot,loadingBar,plotPoints,boundryTrue)
%profile clear;
%profile on;

stepDeg = 5;
stepRads = deg2rad(stepDeg);
qlim = myRobot.model.qlim;
...
for q1 = qlim(1,1):stepRads:qlim(1,2)
    for q2 = qlim(2,1):stepRads:qlim(2,2)
        for q3 = (pi/2 - q2):stepRads:deg2rad(140)
...
fprintf('DoBot Working Volume = %f\n', volume(shp));
