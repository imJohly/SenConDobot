...
%% CreateModel
        function CreateModel(self)       
            ...
            link(3) = Link('d',0,               'a',    0.147,  'alpha',    0,      'offset',   0,      'qlim',[deg2rad(-5),deg2rad(85)]);%need to change
            link(4) = Link('d',0,               'a',    0.06,   'alpha',    pi/2,   'offset',   0,      'qlim',[deg2rad(-180),deg2rad(180)]);
